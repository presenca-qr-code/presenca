...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="administrativo.php">QrCode</a>
	</div>
	<div id="navbar" class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">            
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="administrativo.php?link=9">Listar Matéria </a></li>
			<li><a href="administrativo.php?link=10">Cadastrar Matérias</a></li>     
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="administrativo.php?link=13">Listar Aula</a></li>
			<li><a href="administrativo.php?link=14">Cadastrar Aula</a></li>     
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="administrativo.php?link=17">Listar Turmas</a></li>
			<li><a href="administrativo.php?link=18">Cadastrar Turmas</a></li>     
