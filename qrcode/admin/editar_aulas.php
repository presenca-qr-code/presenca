...
<div class="container theme-showcase" role="main">      
  ...
  <div class="row">
	<div class="col-md-12">
	  <form class="form-horizontal" method="POST" action="processa/proc_edit_aulas.php">
	  
		  <div class="form-group">
			<label for="inputEmail3" class="col-sm-2 control-label">Aulas</label>
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="aulas" placeholder="Aula" value="<?php echo $resultado['aulas']; ?>">
			</div>
		  </div>		  
