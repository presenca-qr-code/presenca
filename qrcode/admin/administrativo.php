...
<html lang="pt-br">
  ...
  <body role="document">
	<?php
		...
		$pag[9] = "listar_materias.php";
		$pag[10] = "cad_materias.php";
		$pag[11] = "visual_materias.php";
		$pag[12] = "editar_materias.php";

		$pag[13] = "listar_aulas.php";
		$pag[14] = "cad_aulas.php";
		$pag[15] = "visual_aulas.php";
		$pag[16] = "editar_aulas.php";



		$pag[17] = "listar_turmas.php";
		$pag[18] = "cad_turmas.php";
		$pag[19] = "visual_turmas.php";
